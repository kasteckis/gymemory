        ...
        {loading ? (
          ...
          <>
            <form onSubmit={formik.handleSubmit}>
              ...
              <Button className={styles.buttonLogin} type={'submit'} variant="contained">
                Login
              </Button>
              <Button
                className={styles.buttonContinueGuest}
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            With guest account there is a chance you might lose your data after your device cache
            restarts! <Link href={'/register'}>To create account, click here!</Link>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button disabled={disableDialogButtons} onClick={handleCloseDialog}>
            Cancel
          </Button>
          <Button disabled={disableDialogButtons} onClick={handleContinueAsGuestConfirmed}>
